        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <motion.div {...fadeUp} className="space-y-7">
            ...
            <p className="text-muted-foreground text-lg max-w-lg leading-relaxed">
              From solo clinics to hospital networks, HealthAuras adapts to your unique workflow and scales with your growth.
            </p>
    ...
    <section className="relative min-h-screen flex items-center py-24">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div {...fadeUp} className="text-center mb-16 space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">See how HealthAuras transforms common healthcare pain points into competitive advantages.</p>
        </motion.div>
    ...
    <section className="relative min-h-[70vh] flex items-center py-24">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div {...fadeUp} className="text-center mb-16 space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">Real results from real healthcare providers using HealthAuras.</p>
        </motion.div>
