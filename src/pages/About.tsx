      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.div {...fadeUp} className="glass-card p-10 max-w-3xl mx-auto space-y-6">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>HealthAuras is a new healthcare AI startup built by IIIT and VIT students and collaborators who share a common frustration: too many clinical tools still feel decades behind.</p>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div {...fadeUp} className="glass-card glow-border p-12 md:p-16 text-center max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto leading-relaxed">
            Discover how HealthAuras can transform your practice with intelligent, end-to-end solutions.
          </p>
